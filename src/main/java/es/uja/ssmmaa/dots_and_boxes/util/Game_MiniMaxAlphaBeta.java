...
import static es.uja.ssmmaa.dots_and_boxes.util.Game_Board.Mark.*;

/**
 *
 * @author nono_
 */
public class Game_MiniMaxAlphaBeta {

    private static final int MAX_DEPTH = 12;

    private Game_MiniMaxAlphaBeta() {
    }
     ...
     */
    public static int miniMax(Game_Board board, int depth, int alpha, int beta,
            boolean isMax) {
     ...
     */
    public static int[] getBestMove(Game_Board board) {
    ...
    /**
     * Evaluate the given board from the perspective of the X player, return 10
     * if a winning board configuration is found, -10 for a losing one and 0 for
     * a draw.
     *
     * @param board Board to evaluate
     * @return value of the board
     */
    private static int evaluateBoard(Game_Board board) {
        int rowSum = 0;
