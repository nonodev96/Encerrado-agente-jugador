 ...
 * @author nonodev96
 */
public class TaskRP_Jugador extends ProposeResponder {

    public TaskRP_Jugador(Agent a, MessageTemplate mt) {
        super(a, mt);
        System.out.println("        --> ProposeResponder(Agent a, MessageTemplate mt)");
    }

    public TaskRP_Jugador(Agent a, MessageTemplate mt, DataStore store) {
        super(a, mt, store);
